...
const RecommendedCard = ({img_url,title,category,price,brand_name,quantity}) => {
  return (
    <>
    ...
    <div className=' w-full h-auto flex items-center justify-center relative group hover:shadow-2xl'>
     ...
     {/*  */}
     <ul className="absolute w-full h-36 bg-gray-100 -bottom-[160px] group-hover:bottom-0 duration-700 flex-col justify-center items-end gap-2">
