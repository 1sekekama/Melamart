...
import { bg3 } from "../../assets/images/sliders";
const Hero3 = () => {
  ...
  return (
    ...
    <div className='absolute top-0 md:px-12  w-full h-full flex flex-col justify-center text-gray-900'>
        <div className='md:px-[3rem] font-[roboto] xl:mt-[10rem]  lg:mt-[9em] mt-[7rem] max-md:mt-[6rem] lg:px-[7rem] max-md:px-[2rem] flex flex-col w-full h-full'>
            ...
            <h2 className='text-2xl xl:mb-2 max-md:mb-[-0.5rem] max-md:text-[10px]'>Weight Control </h2>
            <h2 className='text-2xl font-bold lg:mb-4 xl:mb-5 max-md:mb-[-0.5rem] md:mb-[0.5rem] max-md:text-[10px]'>Vitamins and Supplements </h2>
